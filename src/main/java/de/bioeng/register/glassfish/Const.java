...
class Const {
    ...
    private static final String PACKAGE = Const.class.getPackage().getName();
    ...
    static final String DB_HOST         = PACKAGE + ".DB_HOST";
    static final String DB_PORT         = PACKAGE + ".DB_PORT";
    static final String DB_POOL         = PACKAGE + ".DB_POOL";
    static final String DB_JNDI         = PACKAGE + ".DB_JNDI";
}
